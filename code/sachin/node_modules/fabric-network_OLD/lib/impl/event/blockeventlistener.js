...
class BlockEventListener extends AbstractEventListener {
    ...
    async register() {
        ...
        this._unsetEventHubConnectTimeout();
        this._registration = this.eventHub.registerBlockEvent(this._onEvent.bind(this), this._onError.bind(this), this.clientOptions);
...
//# sourceMappingURL=blockeventlistener.js.map