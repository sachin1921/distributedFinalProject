...
class CommitEventListener extends AbstractEventListener {
    ...
    async register() {
        ...
        const txId = this.eventHub.registerTxEvent(this.transactionId, this._onEvent.bind(this), this._onError.bind(this), Object.assign({ unregister: true }, this.clientOptions));
...
//# sourceMappingURL=commiteventlistener.js.map