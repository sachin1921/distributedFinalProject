    ...
    async register(chaincodeId) {
        ...
        if (this.options.checkpointer) {
            if (typeof this.options.checkpointer.factory === 'function') {
                this.checkpointer = this.options.checkpointer.factory(this.channel.getName(), this.listenerName, this.options.checkpointer.options);
...
//# sourceMappingURL=abstracteventlistener.js.map